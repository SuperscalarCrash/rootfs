...
make_args="-C ${buildroot_dir} O=${output_dir} BR2_EXTERNAL=${root_dir} BR2_DL_DIR=${download_dir} BR2_TOOLCHAIN_EXTERNAL_PATH=${toolchain_dir} GEMMONT_NATIVE_TOOLCHAIN_SITE=${native_toolchain_dir}"
